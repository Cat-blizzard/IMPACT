    ...
    nodes = [
        ...
        Node(package="ego_planner", executable="ego_planner_node", name="impact_ego",
             parameters=[parameters], remappings=[("odom_world", "/xq/p5/ego_odom"),
                ("grid_map/odom", "/xq/p5/ego_odom"), ("grid_map/cloud", "/xq/p5/cloud_map")], output="screen"),
        ...
        autonomy("sitl_mission", dict(session_id=session, result_file=str(run / "mission.json"),
